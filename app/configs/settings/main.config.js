...
module.exports = convict({
	thisNode: {
		hostName: {
			doc: "URLShortener App.",
			format: "ipaddress",
			default: "127.0.0.1",
			env: "HOST_NAME",
		},
		port: {
			doc: "URLShortener App worker port. This is the port that external services will talk to the API.",
			format: "port",
			default: "20200",
			env: "PORT",
		},
		name: {
			doc: "URLShortener App server name",
			format: String,
			default: "URLShortener App ",
			env: "WEB_API_NAME",
		},
		version: {
			doc: "URLShortener App version",
			format: String,
			default: "1.0.0",
			env: "WEB_API_VERSION",
		},
	...
	logger: {
		...
		tag: {
			URLShortenerApi: {
				doc: "fluent label for URLShortenerApi.",
				format: String,
				default: "URLShortenerApi",
